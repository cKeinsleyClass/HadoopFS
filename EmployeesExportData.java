// ORM class for table 'EmployeesExportData'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sun Oct 29 22:57:58 UTC 2017
...
public class EmployeesExportData extends SqoopRecord  implements DBWritable, Writable {
  ...
  public EmployeesExportData with_fname(String fname) {
    this.fname = fname;
    return this;
  }
  ...
  public EmployeesExportData with_lname(String lname) {
    this.lname = lname;
    return this;
  }
  ...
  public EmployeesExportData with_speciality(String speciality) {
    this.speciality = speciality;
    return this;
  }
  private String dept;
  ...
  public EmployeesExportData with_dept(String dept) {
    this.dept = dept;
    return this;
  }
  private Integer eid;
  ...
  public EmployeesExportData with_eid(Integer eid) {
    this.eid = eid;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof EmployeesExportData)) {
      return false;
    }
    EmployeesExportData that = (EmployeesExportData) o;
    boolean equal = true;
...
this.readFields0(__dataIn);  }
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    try {
    __cur_str = __it.next();
    if (__cur_str.equals("This is a Null String")) { this.fname = null; } else {
      this.fname = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("This is a Null String")) { this.lname = null; } else {
      this.lname = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("This is a Null String")) { this.speciality = null; } else {
      this.speciality = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("This is a Null String")) { this.dept = null; } else {
      this.dept = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    EmployeesExportData o = (EmployeesExportData) super.clone();
    return o;
  }

  public void clone0(EmployeesExportData o) throws CloneNotSupportedException {
  }
