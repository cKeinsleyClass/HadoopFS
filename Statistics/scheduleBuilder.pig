...
keyFinalRecords = FOREACH teamRecords GENERATE CONCAT(edu.rosehulman.gilmordw.TrimQuotes(team), edu.rosehulman.gilmordw.TrimQuotes(date), edu.rosehulman.gilmordw.TrimQuotes(number)), edu.rosehulman.gilmordw.TrimQuotes(oppose), $3, $4, $5;
