...
sqoop import --connect jdbc:mysql://$1/sqooptest --username root --table Employees -m 2 --delete-target-dir --null-string 'This is a NULL String' --fields-terminated-by '\t' --warehouse-dir /tmp/sqoop/Employees

hive -e "create database if not exists sqooptest"

sqoop import --connect jdbc:mysql://$1/sqooptest --username root --table Employees -m 2 --hive-import --create-hive-table --hive-table sqooptest.Employees

sqoop import --connect jdbc:mysql://$1/sqooptest --username root --table Employees -m 2 --null-string 'This is a NULL String' --fields-terminated-by '\t' --hive-import --create-hive-table --hive-table sqooptest.Employees
