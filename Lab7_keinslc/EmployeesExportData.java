...
//
// Debug information:
// Generated date: Sat Oct 28 18:18:47 UTC 2017
...
this.readFields0(__dataIn);  }
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    try {
    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.fname = null; } else {
      this.fname = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.lname = null; } else {
      this.lname = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.speciality = null; } else {
      this.speciality = __cur_str;
    }

    __cur_str = __it.next();
    if (__cur_str.equals("\\N")) { this.dept = null; } else {
      this.dept = __cur_str;
    }
